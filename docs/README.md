...
| ------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Treatment plans, sittings, and advance receipts](./specs/treatment-plans-and-advances.md)  | Verification | Four slices and their review fixes have landed with type, lint and test gates green, and the desk flows were exercised in the running app at desktop, 390px and dark (plan from a visit, posting and its double-charge refusal, credit at settlement, Follow-ups, Advances held); a month of pilot use must still show every open course as a plan, no pre-delivery Invoice, and Follow-ups in daily use |
