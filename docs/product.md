...
| Pharmacy/inventory          | **Gate pending Stage 0 walkthrough** — paid scope is signed off; the operational owner and sale/return workflow confirmation remain outstanding; see [Pharmacy counter sale and stock](./specs/pharmacy-counter-sale-and-stock.md) |
