...
- [0003 — Org-scoped pages are client-rendered](./0003-client-rendered-org-pages.md) (superseded by 0021)
...
- [0011 — The organization slug is the request claim](./0011-org-slug-as-request-claim.md) (amended by 0025)
...
- [0017 — Keep AI streaming as a narrow HTTP exception](./0017-ai-streaming-http-surface.md) (superseded by 0024)
...
- [0021 — Org-scoped pages are server-rendered](./0021-server-rendered-org-pages.md)
- [0022 — Outpatient, inpatient and emergency are separate destinations](./0022-care-settings-are-separate-destinations.md) (superseded by 0026)
- [0023 — Charges and invoices hang off the Clinical Encounter](./0023-charges-hang-off-the-clinical-encounter.md) (superseded by 0026)
- [0024 — Remove generic AI chat until it belongs to an owned workflow](./0024-remove-generic-ai-chat.md)
- [0025 — Root organization URLs reserve public and system slugs](./0025-root-org-urls-reserve-system-slugs.md)
- [0026 — One OPD appointment record](./0026-one-opd-appointment-record.md)
