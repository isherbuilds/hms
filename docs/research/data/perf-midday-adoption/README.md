...
The table reports the bounds mathematically. No explicit acceptance of the
three exceptions is recorded with this evidence, so the drift analysis below
does not turn them into passes.
