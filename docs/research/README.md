...
| Frontend adoption      | Measured 2026-08-24 on 40k seeded patients: Base UI combobox pickers, URL-backed patient search, and one optimistic catalog toggle (8 ms flip at Slow 4G vs an ≥800 ms round trip; needs memoized rows at 1,000 items) landed with flat server latency and +103 B route script. TanStack Query stays 5.101.x until oRPC types support 5.102. Evidence: `data/perf-midday-adoption/`. |
