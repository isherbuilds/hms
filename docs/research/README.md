...
| Financial retries      | Bahmni, Danphe, and Marley carry no client operation key; their guards are numbering locks and journal uniqueness, which cannot catch a retried receipt. HMS carries no request key either; retries are resolved by correction documents (D039, superseded).                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
