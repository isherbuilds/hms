  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative rounded-(--cell-radius) has-[:focus-visible]:outline-[2.5px] has-[:focus-visible]:outline-offset-[-2.5px] has-[:focus-visible]:outline-(--focus-ring)",
...
// Re-exported so callers type a range without depending on react-day-picker directly.
export type { DateRange as CalendarRange };
