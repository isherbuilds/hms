...
process.env.DATABASE_URL ??= "postgresql://postgres:postgres@localhost:55432/better_stack_test";
process.env.BETTER_AUTH_SECRET ??= "integration-test-secret-0123456789abcdef";
process.env.BETTER_AUTH_URL ??= "http://localhost:3000";
process.env.CORS_ORIGIN ??= "http://localhost:3001";
process.env.FOUNDING_EMAIL ??= "founder@better-stack.local";
// Matches packages/db/docker-compose.dev.yaml.
process.env.SEAWEEDFS_ENDPOINT ??= "http://localhost:55431";
